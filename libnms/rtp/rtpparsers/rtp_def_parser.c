...
int rtp_def_parser(struct rtp_session *rtp_sess, struct rtp_ssrc *stm_src, char *dst, size_t dst_size, uint32 *timestamp)
{
	rtp_pkt *pkt;
...
int rtp_def_parser_nonblock(struct rtp_session *rtp_sess, struct rtp_ssrc *stm_src, char *dst, size_t dst_size, uint32 *timestamp)
{	
	rtp_pkt *pkt;
	size_t pkt_len, dst_used=0;
	size_t to_cpy;
