/* * 
 *  ./E-gui/nemesi/gui_buff_dial.c: $Revision: 1.1 $ -- $Date: 2002/10/29 12:43:16 $
 *  
...
int gui_buff_dial(void)
{
	...
	dial=GTK_DIAL( lookup_widget(get_egui(NULL), "dial1") );

	if (timer > 0)
		gtk_timeout_remove(timer);
	timer=gtk_timeout_add(50, dial_timeout, (gpointer *) dial);

	return 0;
}

gint dial_timeout(gpointer data)
{
	gfloat new_val;
